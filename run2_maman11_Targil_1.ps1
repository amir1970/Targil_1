...
function Run-Test-Advanced {
    ...
    if ($match -and $match.Context.PostContext.Count -gt 0) {
        # ניקוי השורה שנשלפה מרווחים ומירכאות
    ...
    # הצגה יפה של הקלט גם אם הוא מכיל תווים נסתרים
...
Run-Test-Advanced "" "" "3" "Empty String"
Run-Test-Advanced "   " "" "4" "Only Spaces"
Run-Test-Advanced "a!@# b$%^ c" "a!@#b$%^c" "5" "Special Characters"
Run-Test-Advanced "TAB`tAND`tNEWLINE`n" "TABANDNEWLINE" "6" "Tabs & Newlines"

Write-Host "End of Comprehensive Report." -ForegroundColor Green